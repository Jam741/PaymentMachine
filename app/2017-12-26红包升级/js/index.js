                        ...
                        .then(function (res) {
                            ...
                            if (res.data.state == 1) {
                                if (versionCode >= 1107) {
                                    ...
                                    Print2('预付费存根', this.parkName, this.centralpaymentName, this.plate_number, this.order_price + '元', '现金支付', currentTime(), this.freeOutTime, this.cashReturn, res.data.hbUrl + '&total_amount=' + this.cashReturn );
                                    _close();
                                    ScanClose();
                                } else {
                                    this.showcashpay = false;
